...
type KeyValue interface {
	...
	GetAll() (r map[string]string, err error)
}
...
func (p *KeyValueClient) GetAll() (r map[string]string, err error) {
...
func (p *KeyValueClient) sendGetAll() (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
func (p *KeyValueClient) recvGetAll() (value map[string]string, err error) {
	iprot := p.InputProtocol
	if iprot == nil {
		iprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.InputProtocol = iprot
...
func NewKeyValueProcessor(handler KeyValue) *KeyValueProcessor {
	...
	self10.AddToProcessorMap("GetAll", &keyValueProcessorGetAll{handler: handler})
	return self10
}
...
type keyValueProcessorGetAll struct {
	handler KeyValue
}

func (p *keyValueProcessorGetAll) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := KeyValueGetAllArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
type KeyValueGetAllArgs struct {
}

func NewKeyValueGetAllArgs() *KeyValueGetAllArgs {
	return &KeyValueGetAllArgs{}
}

func (p *KeyValueGetAllArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *KeyValueGetAllArgs) Write(oprot thrift.TProtocol) error {
...
func (p *KeyValueGetAllArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("KeyValueGetAllArgs(%+v)", *p)
}

// Attributes:
//  - Success
type KeyValueGetAllResult struct {
	Success map[string]string `thrift:"success,0" json:"success,omitempty"`
}

func NewKeyValueGetAllResult() *KeyValueGetAllResult {
	return &KeyValueGetAllResult{}
}

var KeyValueGetAllResult_Success_DEFAULT map[string]string

func (p *KeyValueGetAllResult) GetSuccess() map[string]string {
	return p.Success
}
func (p *KeyValueGetAllResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *KeyValueGetAllResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *KeyValueGetAllResult) readField0(iprot thrift.TProtocol) error {
...
func (p *KeyValueGetAllResult) Write(oprot thrift.TProtocol) error {
...
func (p *KeyValueGetAllResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *KeyValueGetAllResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("KeyValueGetAllResult(%+v)", *p)
}
