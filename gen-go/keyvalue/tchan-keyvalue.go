...
type TChanKeyValue interface {
	...
	GetAll(ctx thrift.Context) (map[string]string, error)
...
func (c *tchanKeyValueClient) GetAll(ctx thrift.Context) (map[string]string, error) {
	var resp KeyValueGetAllResult
...
func (s *tchanKeyValueServer) handleGetAll(ctx thrift.Context, protocol athrift.TProtocol) (bool, athrift.TStruct, error) {
	var req KeyValueGetAllArgs
	var res KeyValueGetAllResult
